...
/**
* getstr - read a string from command line
* @str: a string pointer
*
* Return: return 1 in success.Otherwise -1
*/
...
/**
* strmix - copy to strings and concatenate if
*	   destination have a string already.
* @src: string to be copied
...
/**
* strbrk - breaks a long string in to array of strings
